...
export async function POST(request: Request) {
    ...
    try {
        ...
        return NextResponse.json({ 
            message: 'Erro ao criar Comentário.', error 
            }, { 
            status: 500 
        });
    }
...
export async function PUT(request: Request) {
    try {
        ...
        console.log(error);
        return NextResponse.json({ 
            message: 'Erro ao atualizar comentário.', error 
            }, { 
            status: 500 
        });
    }
...
export async function DELETE(request: Request) {
    try {
        ...
        return NextResponse.json({ message: 'Comentário deletado com sucesso' }, { status: 200 });
        } catch(error) {
        //TRATAMENTO DE ERROS E RETORNO PARA O FRONTEND COM MENSAGEM E STATUS
        console.log(error)
        return NextResponse.json({ 
            message: 'Erro ao deletar comentário.', error 
            }, { 
            status: 500 
        });
    }
